...
This project is indexed by GitNexus as **knight-bus-graph-walker** (15182 symbols, 19106 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
