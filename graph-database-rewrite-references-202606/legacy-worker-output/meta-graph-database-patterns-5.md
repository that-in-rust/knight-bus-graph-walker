...
- CodeGraphContext completed on the working repo and on assigned `lazy-tool`.
  Neo4j testkit, `boltstub_rs`, and `tracing-src` CGC runs were incomplete and
  are documented as gaps rather than treated as evidence.
