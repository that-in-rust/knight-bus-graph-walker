...
This project is indexed by GitNexus as **knight-bus-graph-walker** (12945 symbols, 16125 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
