...
Taste judgment: use Dgraph when designing distributed or LSM-backed property/index storage. Its GraphQL/RDF-like model is not the same as Neo4j, but its version retention and rollup patterns matter.
